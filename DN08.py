def hitrejsi_kolesar(kolesar1, kolesar2, razmerja):
    if kolesar1 == kolesar2:
        return True
    for kolesar in razmerja[kolesar1]:
        if hitrejsi_kolesar(kolesar, kolesar2, razmerja):
            return True
    return False

def hitrejsi(kolesar1, kolesar2, razmerja):
    if hitrejsi_kolesar(kolesar1, kolesar2, razmerja):
        return kolesar1
    if hitrejsi_kolesar(kolesar2, kolesar1, razmerja):
        return kolesar2
    return None
...
def dokazov(kolesar1, kolesar2, razmerja):
    if kolesar1 == kolesar2:
        return True
    stevilo_dokazov = 0
    obiskani.add(kolesar1)
    for kolesar in razmerja[kolesar1]:
        if kolesar not in obiskani:
            stevilo_dokazov += dokazov(kolesar, kolesar2, razmerja)
    obiskani.remove(kolesar1)
    return stevilo_dokazov
